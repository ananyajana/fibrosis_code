...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 27 15:55:22 2020
...
import torch
import math
def ElasticTransform(img, alpha, sigma):
	H = img.shape[0]
	W = img.shape[1]
...
if __name__ == "__main__":
    ...
    b = Image.open('./data/lits_30_pat/train/5.png')
    ...
    original1.show()
    """
    #original1 = add_uniform_noise(original, -25, 25)
    original1 = elastic_transform(original, 100, 4, None)
